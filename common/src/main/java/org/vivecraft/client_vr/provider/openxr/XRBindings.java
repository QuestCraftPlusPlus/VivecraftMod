...
public class XRBindings {
    ...
    private static HashSet<Pair<String, String>> quest2Bindings() {
        ...
        set.add(new MutablePair<>("/actions/global/in/key.inventory", "/user/hand/left/input/y/click"));
        ...
        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.teleport", "/user/hand/left/input/x/click"));
        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.radialMenu", "/user/hand/right/input/b/click"));
        set.add(new MutablePair<>("/actions/ingame/in/key.use", "/user/hand/left/input/trigger"));
        ...
        set.add(new MutablePair<>("/actions/ingame/in/vivecraft.key.teleportFallback", "/user/hand/left/input/x/click"));
        set.add(new MutablePair<>("/actions/ingame/in/key.jump", "/user/hand/right/input/a/click"));
